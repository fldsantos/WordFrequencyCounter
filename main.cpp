...
// This class was written so it can hold the word's text and its frequency, and so the words can be sorted inside the vector
class Word
{
public:
    std::string text;
...
//This class will be used mainly for its only method, so it can be called anywhere in the main function.
class WordFrequencyCounter
{
public:
    vector<Word> CountWordFrequency(string s)
    {
        // Declaring vectors and useful variables
        vector<string> words;
